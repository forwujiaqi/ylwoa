    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">编辑到货清单</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <form role="form" id="form" method="post" action="${pageContext.request.contextPath}/arrive/edit">
                    <div class="row">
                        <div class="col-lg-12" >
                            <input value="${data.excelName}" id="excelName" name="excelName" class="form-control" placeholder="请填写到货清单名" style="width: 500px">
                            <br>
                        </div>
                        <div class="col-lg-12" >
                    ...
                    <div class="row">
                        <div class="col-lg-12" style="text-align:center;width:100%">
                            ...
                            <a href="/arrive/list/0" class="btn btn-warning" role="button">退出</a>
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
                </form>
