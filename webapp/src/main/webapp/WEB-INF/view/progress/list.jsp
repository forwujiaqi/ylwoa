...
<script>
    ...
    function showProgress(progressId) {
        document.form1.action = "${ctx}/progress/toView/" + progressId;
        document.form1.submit();
        return true;
    }

    function editProgress(progressId) {
        document.form1.action = "${ctx}/progress/toEdit/" + progressId;
        document.form1.submit();
        return true;
    }
    ...
    function deleteProgress(progressId) {
        if (confirm('确定要删除吗?')) {
            document.form1.action = "${ctx}/progress/delete/" + progressId;
            document.form1.submit();
            return true;
        }
        return false;
