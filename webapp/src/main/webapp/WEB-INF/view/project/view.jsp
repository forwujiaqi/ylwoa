        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <form role="form" id="form" method="post" action="${pageContext.request.contextPath}/project/edit">
                    <div class="row">
                        <div class="col-lg-12" >
                            <input readonly="readonly" id="projectName" name="projectName" class="form-control" value="${data.projectName}" placeholder="请填写工程名称" style="width: 500px">
                            <br>
                        </div>
                        <div class="col-lg-12" >
                            <textarea  readonly="readonly" style="width: 500px" id="remark" name="remark" class="form-control" rows="10" placeholder="请填写备注">${data.remark}</textarea>
                        </div>
                    <!-- /.col-lg-12 -->
                    </div>
                    <div class="row">
