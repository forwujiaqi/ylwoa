    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">新建工程</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <form role="form" id="form" method="post" action="${pageContext.request.contextPath}/project/add">
                    <div class="row">
                        <div class="col-lg-12" >
                            <input id="projectName" name="projectName" class="form-control" placeholder="请填写工程名称"
                                   style="width: 500px">

                            <br>
                        </div>
                        <div class="col-lg-12" >
                            <textarea style="width: 500px" id="remark" name="remark" class="form-control" rows="10" placeholder="请填写备注"></textarea>
                        </div>
                    <!-- /.col-lg-12 -->
                    </div>
                    <div class="row">
                        <div class="col-lg-12" style="text-align:center;width:100%">
                            ...
                            <a href="/project/list/0" class="btn btn-warning" role="button">退出</a>
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
                </form>
